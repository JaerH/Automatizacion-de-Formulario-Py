...
def exportar_datos(dataFrame):
    ...
    with open("../output/script.sql", "w" , encoding="utf-8"):
        for index, row in dataFrame.iterrows():
            ...
            print('INSERT INTO CEPAL_T_D_FORM_FORMULARIO (CO_ID,FORM_CO_CODIGO,FORM_NM_NOMBRE,FORM_LI_DESCRIPCION,FORM_NM_NOMBREARCHIVO,FORM_NM_EXTENSION,FORM_CO_ID_ALFRESCO,FORM_LI_URI_ALFRESCO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION,IN_CONTROL_CONCURRENCIA,FORM_NU_VERSION,FORM_FE_FECHA_VERSION,FORM_IN_VIGENTE,FORM_IN_ESPECIFICO) VALUES (',
                  ...
                  '0',
                  ');',
                  "",sep="",file=open("../output/script.sql", "a"))
           ...
           # print("INSERT INTO CEPAL_T_R_PRFO_PROC_FORM (PRFO_CO_PROCEDIMIENTO, PRFO_CO_FORMULARIO) VALUES ('","PROC_", row['CÓDIGO DE PROCEDIMIENTO'],"','",row['CÓDIGO DE PLANTILLA'],"');",sep="", file=open("../output/script.sql", "a"))
            ...
            if row['BLOQUE GENÉRICO DATOS SOLICITANTE']  == 'SI':
                            print("INSERT INTO CEPAL_T_D_PAGI_PAGINA (CO_ID,PAGI_CO_CODIGO,PAGI_CO_ID_VISTA,PAGI_NM_NOMBRE,PAGI_NU_ORDEN,PAGI_CO_FORMULARIO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_PF_A', 'AL32UTF8'))) Alias from dual),'DATOS_PERSONALES_CONTACTO','page_5CyBvb7Uv1','DATOS PERSONALES Y DE CONTACTO',","0,'",row['CÓDIGO DE PLANTILLA'],"',(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ),",'0,',"SYSDATE",");",sep="", file=open("../output/script.sql", "a"))
            if row['DATOS ESPECÍFICOS']  == 'SI':
                            print("INSERT INTO CEPAL_T_D_PAGI_PAGINA (CO_ID,PAGI_CO_CODIGO,PAGI_CO_ID_VISTA,PAGI_NM_NOMBRE,PAGI_NU_ORDEN,PAGI_CO_FORMULARIO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_PF_B', 'AL32UTF8'))) Alias from dual),'DATOS_ESPECIFICOS','page_5CyBvb7Uv1','DATOS ESPECÍFICOS',","1,'",row['CÓDIGO DE PLANTILLA'],"',(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ),",'0,',"SYSDATE",");",sep="", file=open("../output/script.sql", "a"))
            if row['DOCUMENTACIÓN; CONSENTIMIENTO Y AUTORIZACIONES']  == 'SI':
                            print("INSERT INTO CEPAL_T_D_PAGI_PAGINA (CO_ID,PAGI_CO_CODIGO,PAGI_CO_ID_VISTA,PAGI_NM_NOMBRE,PAGI_NU_ORDEN,PAGI_CO_FORMULARIO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_PF_C', 'AL32UTF8'))) Alias from dual),'DOCUMENTACION','page_5CyBvb7Uv1','DOCUMENTACIÓN; CONSENTIMIENTO Y AUTORIZACIONES',","2,'",row['CÓDIGO DE PLANTILLA'],"',(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ),",'0,',"SYSDATE",");",sep="", file=open("../output/script.sql", "a"))
            if row['AVISOS Y NOTIFICACIONES']  == 'SI':
                            print("INSERT INTO CEPAL_T_D_PAGI_PAGINA (CO_ID,PAGI_CO_CODIGO,PAGI_CO_ID_VISTA,PAGI_NM_NOMBRE,PAGI_NU_ORDEN,PAGI_CO_FORMULARIO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_PF_D', 'AL32UTF8'))) Alias from dual),'AVISOS','page_5CyBvb7Uv1','AVISOS Y NOTIFICACIONES',","3,'",row['CÓDIGO DE PLANTILLA'],"',(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ),",'0,',"SYSDATE",");",sep="", file=open("../output/script.sql", "a"))
            if row['DECLARACIÓN RESPONSABLE']  == 'SI':
                            print("INSERT INTO CEPAL_T_D_PAGI_PAGINA (CO_ID,PAGI_CO_CODIGO,PAGI_CO_ID_VISTA,PAGI_NM_NOMBRE,PAGI_NU_ORDEN,PAGI_CO_FORMULARIO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_PF_E', 'AL32UTF8'))) Alias from dual),'GDPR_PAGE','page_5CyBvb7Uv1','DECLARACIÓN RESPONSABLE',","4,'",row['CÓDIGO DE PLANTILLA'],"',(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ),",'0,',"SYSDATE",");",sep="", file=open("../output/script.sql", "a"))                
            ...
            if row['BLOQUE GENÉRICO DATOS SOLICITANTE']=='SI':
               print("INSERT INTO CEPAL_T_D_PAEL_PAGI_ELCO (CO_ID,PAEL_CO_PAGINA,PAEL_CO_ELEMENTOCOMPUESTO,PAEL_CO_PREFIJO_REUTILIZABLE,PAEL_CO_ID_VISTA,PAEL_NU_ORDEN_ELEM_COMP,IN_ELIMINADO,FE_FECHA_CREACION,CO_USUARIO_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_DP_A', 'AL32UTF8'))) Alias from dual),(SELECT CO_ID FROM CEPAL_T_D_PAGI_PAGINA WHERE PAGI_CO_CODIGO = 'DATOS_PERSONALES_CONTACTO' AND PAGI_CO_FORMULARIO = '",row['CÓDIGO DE PLANTILLA'],"'),(SELECT CO_ID FROM CEPAL_T_D_ELCO_ELEM_COMPUESTO WHERE ELCO_CO_CODIGO = 'SOLICITANTE' AND ELCO_IN_REUTILIZABLE = 1 AND ELCO_IN_VIGENTE = 1),'CES_SOL','contenedor_t2w9B9Cnup',2,0,SYSDATE,(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T'AND IN_ELIMINADO = 0));",sep="",file=open("../output/script.sql", "a"))          
           
            
            print("-- REPRESENTANTE" , file=open("../output/script.sql" , "a"))
            if row['BLOQUE GENÉRICO DATOS DEL REPRESENTANTE']=='SI':
               print("INSERT INTO CEPAL_T_D_PAEL_PAGI_ELCO (CO_ID,PAEL_CO_PAGINA,PAEL_CO_ELEMENTOCOMPUESTO,PAEL_CO_PREFIJO_REUTILIZABLE,PAEL_CO_ID_VISTA,PAEL_NU_ORDEN_ELEM_COMP,IN_ELIMINADO,FE_FECHA_CREACION,CO_USUARIO_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_DP_B', 'AL32UTF8'))) Alias from dual),(SELECT CO_ID FROM CEPAL_T_D_PAGI_PAGINA WHERE PAGI_CO_CODIGO = 'DATOS_PERSONALES_CONTACTO' AND PAGI_CO_FORMULARIO = '",row['CÓDIGO DE PLANTILLA'],"'),(SELECT CO_ID FROM CEPAL_T_D_ELCO_ELEM_COMPUESTO WHERE ELCO_CO_CODIGO = 'REPRESENTANTE'AND ELCO_IN_REUTILIZABLE = 1 AND ELCO_IN_VIGENTE = 1), 'CES_SOL','contenedor_t2w9B9Cnup',2,0,SYSDATE,(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T'AND IN_ELIMINADO = 0));",sep="",file=open("../output/script.sql", "a"))        
        
            
            print("-- MEDIO" , file=open("../output/script.sql" , "a"))
            if row['BLOQUE GENÉRICO MEDIO PREFERENTE']=='SI':
               print("INSERT INTO CEPAL_T_D_PAEL_PAGI_ELCO ( CO_ID, PAEL_CO_PAGINA, PAEL_CO_ELEMENTOCOMPUESTO, PAEL_CO_PREFIJO_REUTILIZABLE, PAEL_CO_ID_VISTA, PAEL_NU_ORDEN_ELEM_COMP, IN_ELIMINADO, FE_FECHA_CREACION, CO_USUARIO_CREACION ) VALUES ( ( SELECT LOWER( DBMS_OBFUSCATION_TOOLKIT.md5( input => UTL_I18N.STRING_TO_RAW ('CON_CES_DP_C', 'AL32UTF8') ) ) Alias from dual ), ( SELECT CO_ID FROM CEPAL_T_D_PAGI_PAGINA WHERE PAGI_CO_CODIGO = 'DATOS_PERSONALES_CONTACTO' AND PAGI_CO_FORMULARIO = '",row['CÓDIGO DE PLANTILLA'],"' ), ( SELECT CO_ID FROM CEPAL_T_D_ELCO_ELEM_COMPUESTO WHERE ELCO_CO_CODIGO = 'MEDIO' AND ELCO_IN_REUTILIZABLE = 1 AND ELCO_IN_VIGENTE = 1  ), 'CES_MED', 'contenedor_t2w9B9Cnup', 2, 0, SYSDATE, ( SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ) );",sep="",file=open("../output/script.sql", "a"))        
            ...
            if row['OPOSICIÓN']== 'SI':
                print("INSERT INTO CEPAL_T_D_PAEL_PAGI_ELCO ( CO_ID, PAEL_CO_PAGINA, PAEL_CO_ELEMENTOCOMPUESTO, PAEL_CO_PREFIJO_REUTILIZABLE, PAEL_CO_ID_VISTA, PAEL_NU_ORDEN_ELEM_COMP, IN_ELIMINADO, FE_FECHA_CREACION, CO_USUARIO_CREACION ) VALUES ( ( SELECT LOWER( DBMS_OBFUSCATION_TOOLKIT.md5( input => UTL_I18N.STRING_TO_RAW ('CON_CES_DO_A', 'AL32UTF8') ) ) Alias from dual ), ( SELECT CO_ID FROM CEPAL_T_D_PAGI_PAGINA WHERE PAGI_CO_CODIGO = 'DOCUMENTACION' AND PAGI_CO_FORMULARIO = '",row['CÓDIGO DE PLANTILLA'],"' ), ( SELECT CO_ID FROM CEPAL_T_D_ELCO_ELEM_COMPUESTO WHERE ELCO_CO_CODIGO = 'DER_OPOSICION' ), 'CES_', 'contenedor_VAoH5NBdv4', 1, 0, SYSDATE, ( SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ) );",sep="",file=open("../output/script.sql", "a"))
            
            
            if row['AVISOS Y NOTIFICACIONES'] == 'SI':
                print("INSERT INTO CEPAL_T_D_PAEL_PAGI_ELCO (CO_ID, PAEL_CO_PAGINA,PAEL_CO_ELEMENTOCOMPUESTO,PAEL_CO_PREFIJO_REUTILIZABLE,PAEL_CO_ID_VISTA,PAEL_NU_ORDEN_ELEM_COMP,IN_ELIMINADO,FE_FECHA_CREACION,CO_USUARIO_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_DO_B', 'AL32UTF8'))) Alias from dual),(SELECT CO_ID FROM CEPAL_T_D_PAGI_PAGINA WHERE PAGI_CO_CODIGO = 'AVISOS' AND PAGI_CO_FORMULARIO = '",row['CÓDIGO DE PLANTILLA'],"'), (SELECT CO_ID FROM (SELECT CO_ID, ELCO_NU_VERSION FROM CEPAL_T_D_ELCO_ELEM_COMPUESTO WHERE ELCO_CO_CODIGO = 'GDPR' AND ELCO_IN_REUTILIZABLE=1 AND ELCO_IN_VIGENTE=1  ORDER BY ELCO_NU_VERSION DESC) WHERE  ROWNUM = 1) , 'RCM_' , 'contenedor_nb2PrG9QIu' , 0, 0, SYSDATE,(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T'AND IN_ELIMINADO = 0 ));",sep="" , file=open("../output/script.sql", "a"))
         
            
            if row['DECLARACIÓN RESPONSABLE'] == 'SI':
                print("INSERT INTO CEPAL_T_D_PAEL_PAGI_ELCO (CO_ID, PAEL_CO_PAGINA,PAEL_CO_ELEMENTOCOMPUESTO,PAEL_CO_PREFIJO_REUTILIZABLE,PAEL_CO_ID_VISTA,PAEL_NU_ORDEN_ELEM_COMP,IN_ELIMINADO,FE_FECHA_CREACION,CO_USUARIO_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_DO_C', 'AL32UTF8'))) Alias from dual) , (SELECT CO_ID FROM CEPAL_T_D_PAGI_PAGINA WHERE PAGI_CO_CODIGO = 'GDPR_PAGE' AND PAGI_CO_FORMULARIO = '",row['CÓDIGO DE PLANTILLA'],"'), (SELECT CO_ID FROM (SELECT CO_ID, ELCO_NU_VERSION FROM CEPAL_T_D_ELCO_ELEM_COMPUESTO WHERE ELCO_CO_CODIGO = 'GDPR' AND ELCO_IN_REUTILIZABLE=1 AND ELCO_IN_VIGENTE=1  ORDER BY ELCO_NU_VERSION DESC) WHERE  ROWNUM = 1) , 'RCM_' , 'contenedor_nb2PrG9QIu' , 0, 0, SYSDATE,(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T'AND IN_ELIMINADO = 0 ));" ,sep="", file=open("../output/script.sql", "a"))
