    ...
    with open("../output/script_original/script.sql", "w" , encoding="utf-8"):
        for index, row in dataFrame.iterrows():
            ...
            if row['DATOS ESPECÍFICOS']  == 'SI':
                            print("INSERT INTO CEPAL_T_D_PAGI_PAGINA (CO_ID,PAGI_CO_CODIGO,PAGI_CO_ID_VISTA,PAGI_NM_NOMBRE,PAGI_NU_ORDEN,PAGI_CO_FORMULARIO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_PF_B",increment,"', 'AL32UTF8'))) Alias from dual),'DATOS_ESPECIFICOS','page_5CyBvb7Uv12','DATOS ESPECÍFICOS',","1,'",row['CÓDIGO DE PLANTILLA'],"',(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ),",'0,',"SYSDATE",");",sep="", file=open("../output/script_original/script.sql", "a"))
            if row['DOCUMENTACIÓN; CONSENTIMIENTO Y AUTORIZACIONES']  == 'SI':
                            print("INSERT INTO CEPAL_T_D_PAGI_PAGINA (CO_ID,PAGI_CO_CODIGO,PAGI_CO_ID_VISTA,PAGI_NM_NOMBRE,PAGI_NU_ORDEN,PAGI_CO_FORMULARIO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_PF_C",increment,"', 'AL32UTF8'))) Alias from dual),'DOCUMENTACION','page_5CyBvb7Uv13','DOCUMENTACIÓN; CONSENTIMIENTO Y AUTORIZACIONES',","2,'",row['CÓDIGO DE PLANTILLA'],"',(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ),",'0,',"SYSDATE",");",sep="", file=open("../output/script_original/script.sql", "a"))
            if row['AVISOS Y NOTIFICACIONES']  == 'SI':
                            print("INSERT INTO CEPAL_T_D_PAGI_PAGINA (CO_ID,PAGI_CO_CODIGO,PAGI_CO_ID_VISTA,PAGI_NM_NOMBRE,PAGI_NU_ORDEN,PAGI_CO_FORMULARIO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_PF_D",increment,"', 'AL32UTF8'))) Alias from dual),'AVISOS','page_5CyBvb7Uv14','AVISOS Y NOTIFICACIONES',","3,'",row['CÓDIGO DE PLANTILLA'],"',(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ),",'0,',"SYSDATE",");",sep="", file=open("../output/script_original/script.sql", "a"))
            if row['DECLARACIÓN RESPONSABLE']  == 'SI':
                            print("INSERT INTO CEPAL_T_D_PAGI_PAGINA (CO_ID,PAGI_CO_CODIGO,PAGI_CO_ID_VISTA,PAGI_NM_NOMBRE,PAGI_NU_ORDEN,PAGI_CO_FORMULARIO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION) VALUES ((SELECT LOWER(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_I18N.STRING_TO_RAW ('CON_CES_PF_E",increment,"', 'AL32UTF8'))) Alias from dual),'GDPR_PAGE','page_5CyBvb7Uv15','DECLARACIÓN RESPONSABLE',","4,'",row['CÓDIGO DE PLANTILLA'],"',(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0 ),",'0,',"SYSDATE",");",sep="", file=open("../output/script_original/script.sql", "a"))                
