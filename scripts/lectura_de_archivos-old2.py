...
def exportar_datos(dataFrame):
    ...
    increment=0
    pathOutput = '../output/script_original/script.sql' 
    ...
    with open("../output/script_original/script.sql", "w" , encoding="utf-8"):
        for index, row in dataFrame.iterrows():
            ...
            print("-- ===============================================================",file=open(pathOutput, "a"))
            print("-- Script para el procedimiento ", row['CÓDIGO DE FORMULARIO'],file=open(pathOutput, "a"))
            print("-- ===============================================================",file=open(pathOutput, "a"))
            print("-- 01",row['CÓDIGO DE FORMULARIO'],"-Formulario'", file=open(pathOutput, "a"))
            ...
            print("INSERT INTO CEPAL_T_D_FOES_FORM_ESTADO (CO_ID,FOES_CO_FORMULARIO,FOES_CO_FLUJO_ESTADO,FOES_IN_ACTIVO,CO_USUARIO_CREACION,IN_ELIMINADO,FE_FECHA_CREACION,IN_CONTROL_CONCURRENCIA) VALUES (", "'FOES_", row['CÓDIGO DE FORMULARIO'], "','", row[
                  'CÓDIGO DE PLANTILLA'], "',", "(SELECT CO_ID FROM CEPAL_T_M_FLES_FLUJO_ESTADO WHERE FLES_CO_CODIGO = 'VALID_FIN_FORM'),", '1,', "(SELECT CO_ID FROM CEPAL_T_D_USUA_USUARIOS WHERE USUA_LI_LOGIN = '00000000T' AND IN_ELIMINADO = 0),", '0,', "SYSDATE,", '0);',sep="", file=open(pathOutput, "a"))
                  
            print("INSERT INTO CEPAL_T_R_FOBL_FORM_BLMA (FOBL_CO_BLOQUEMATERIA, FOBL_CO_FORMULARIO) VALUES (", "'BLOQUE_MATERIA_3','", row['CÓDIGO DE PLANTILLA'], "');",sep="", file=open(pathOutput, "a"))
